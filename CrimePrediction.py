...
df_year=pd.read_csv(f'PythonFlask/static/Data/{req_data["city"]}_2001_2023.csv')
...
#       file = open(f'PythonFlask/Models/{req_data["city"]}_{req_data["model"]}.joblib', 'wb')
#       joblib.dump(model, file)
#       file.close()
#       file = open(f'PythonFlask/Models/{req_data["city"]}_{req_data["model"]}.joblib', 'rb')
