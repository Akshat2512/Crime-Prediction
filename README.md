...
[Deployed URL](https://crime-prediction-steel.vercel.app/)<br><br>
...
Here is the code for training the models using various machine learning regressor, such as XGBoost, Decision Tree, Random Forest, LightGBM, and Linear Regression -> [Code](Extra/Collab)
