...
def run_1():
    ...
    output = subprocess.check_output(['python', 'PythonFlask/CrimePrediction.py', data])
...
def run_2():
    data = request.json
    data = json.dumps(data)
    output = subprocess.check_output(['python', 'PythonFlask/filterdata.py', data])
